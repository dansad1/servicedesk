def create_permissions(apps, schema_editor):
    ...
    CustomPermission.objects.create(code_name="requests_can_add_executors",
                                    name="Назначать исполнителей и группы исполнителей")
    ...
    CustomPermission.objects.create(code_name="users_can_edit",
                                    name="Редактировать пользователей и группы исполнителей")
    ...
    CustomPermission.objects.create(code_name="departments_can_delete", name="Удалять отделы")
    ...
    CustomPermission.objects.create(code_name="status_trans_can_delete", name="Удалять переходы статусов")
    ...
    CustomPermission.objects.create(code_name="interface_can_view_requests", name='Показывать раздел "Список заявок"')
    CustomPermission.objects.create(code_name="interface_can_view_assets", name='Показывать раздел "Список активов"')
    ...
    CustomPermission.objects.create(code_name="interface_can_view_companies",
                                    name='Показывать раздел "Список компаний"')
    CustomPermission.objects.create(code_name="interface_can_view_users",
                                    name='Показывать раздел "Список пользователей"')
